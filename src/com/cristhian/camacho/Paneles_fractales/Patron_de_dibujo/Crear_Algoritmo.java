...
import com.cristhian.camacho.Paneles_fractales.Patron_recursivo.*;
import com.cristhian.camacho.Paneles_fractales.Patron_de_dibujo.*;
...
//        	}
  ...
  public void settearBarraDeProgresoValoresIniciales()
  {
	  ...
	  elementos_UI.panel_de_dibujo.progresoFractal.setMinimum(0);
	  elementos_UI.panel_de_dibujo.progresoFractal.setMaximum(maximo);
	  elementos_UI.panel_de_dibujo.progresoFractal.setValue(0);
  ...
  public void incrementarBarraDeProgresoEnUno()
  {
	//// para settear la barra de progreso
  	int valIni = elementos_UI.panel_de_dibujo.progresoFractal.getValue();
  	elementos_UI.panel_de_dibujo.progresoFractal.setValue(valIni+1);
  	...
  	int actual = elementos_UI.panel_de_dibujo.progresoFractal.getValue();
  	int maximo = elementos_UI.panel_de_dibujo.progresoFractal.getMaximum();
  	...
  	elementos_UI.panel_de_dibujo.tiempoRestanteFractal.setText("faltan "+tiempoRestanteMin+":"+tiempoRestanteSeg);
