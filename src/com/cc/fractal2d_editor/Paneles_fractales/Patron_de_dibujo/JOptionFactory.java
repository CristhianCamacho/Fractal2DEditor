...
import com.cc.fractal2d_editor.Paneles_fractales.Patron_de_dibujo.strokes.*;
...
public class JOptionFactory {
    ...
    public static void showStrokeDialog(Elementos_UI elementos_ui) {
        ...
        if(elementos_ui.panel_de_dibujo.panel_de_dibujo.getStroke() != null) {

            try {
                Stroke s_tmp = elementos_ui.panel_de_dibujo.panel_de_dibujo.getStroke();
...
/*
                                             Font font1 = new Font("TimesRoman", Font.PLAIN, 10);
                                             TextStroke t_stroke = new TextStroke(" Aqui va el texto ", font1 , false, true);

                                             ZigzagStroke z_stroke = new ZigzagStroke(t_stroke, 15, 15);
//pasarle grosor como parametro
                                             CompositeStroke.CompoundStroke c_stroke = new CompositeStroke.CompoundStroke(getStrokeCirculoYEstrellas(Float.parseFloat(jtf_width.getText())), getStrokeVacio(5,0.5f), CompositeStroke.CompoundStroke.SUBTRACT);
*/

                                             elementos_ui.panel_de_dibujo.panel_de_dibujo.setStroke(result_stroke);
