        ...
        implements ActionListener
{
    ...
    public static File LISTA_DE_FILES_RECIENTES = new File(Constants.DIR_DE_PROPIEDADES, "recientes.fracFiles");;
    ...
    public void actionPerformed(ActionEvent actionevent)
    {
        ...
        aux_s=aux_s.substring( 0,aux_s.length()- Filtro_fractales.extension.length() );

        Vector v = Flujo.leer(aux);

        Elementos_UI.instance.set_nombre_del_modelo( aux_s );
        Elementos_UI.instance.datos_para_abrir( v );
