...
import com.cristhian.camacho.IO_fractales.Abrir_fractales;
import com.cristhian.camacho.IO_fractales.Guardar_fractales;
import com.cristhian.camacho.IO_fractales.Guardar_fractales_como_PNG;
...
import com.cristhian.camacho.Paneles_fractales.Patron_de_dibujo.Panel_resultado;
import com.cristhian.camacho.Rutinas.VentanaDeCrearRutina;
import com.cristhian.camacho.command.StatePointsButtonCommand;
        ...
        if(o instanceof JMenuItem)
        {
            ...
            else if(jmi.getText().equals("estrellas"))
            {
			 ...
			 String salto = JOptionPane.showInputDialog(null,
					   								   ...
					   								   JOptionPane.QUESTION_MESSAGE);
			 */
                com.cristhian.camacho.Rutinas.VentaDeCrearEstrella.getInstance().setElementosUI(elementos_ui);
                com.cristhian.camacho.Rutinas.VentaDeCrearEstrella.getInstance().mostrar();
            ...
            {
                com.cristhian.camacho.Rutinas.VentaDeCrearEneagono.getInstance().setElementosUI(elementos_ui);
                com.cristhian.camacho.Rutinas.VentaDeCrearEneagono.getInstance().mostrar();
			/*
			 String nroDePuntas = JOptionPane.showInputDialog(null,
        ...
        if( e.getSource() instanceof JButton )
        {
            ...
            if(aux.equals("colocar_puntos"))
            {
                StatePointsButtonCommand insertpoint = new StatePointsButtonCommand(panel_patron,
                        ...
                        false);
                insertpoint.execute();
                com.cristhian.camacho.command.ListaDeAcciones.getInstance().undoStackPush(insertpoint);
				/*
